...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Supplier<RuntimeException> notFoundUom = () -> new RuntimeException("Expected UOM Not Found");
        Supplier<RuntimeException> notFoundCategory = () -> new RuntimeException("Expected Category Not Found");

        UnitOfMeasure eachUom = unitOfMeasureRepository.findByDescription("Each").orElseThrow(notFoundUom);

        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findByDescription("Tablespoon").orElseThrow(notFoundUom);

        UnitOfMeasure teaSpoonUom = unitOfMeasureRepository.findByDescription("Teaspoon").orElseThrow(notFoundUom);

        UnitOfMeasure dashUom = unitOfMeasureRepository.findByDescription("Dash").orElseThrow(notFoundUom);

        UnitOfMeasure pintUom = unitOfMeasureRepository.findByDescription("Pint").orElseThrow(notFoundUom);

        UnitOfMeasure cupsUom = unitOfMeasureRepository.findByDescription("Cup").orElseThrow(notFoundUom);
        // get Categories
        Category americanCategory = categoryRepository.findByDescription("American").orElseThrow(notFoundCategory);
        Category mexicanCategory = categoryRepository.findByDescription("Mexican").orElseThrow(notFoundCategory);
        // Yummy Guac
